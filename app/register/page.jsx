...
export default function UserRegister() {
  ...
  const userRoles = ["Customer", "Handyman"];
  return (
    <div className="mx-auto md:w-[60%] flex flex-col justify-center items-center my-10">
      <div className="w-[90%] mx-auto md:w-[60%] flex flex-col gap-5">
        <div>
          <h2 className="text-4xl font-bold leading-12 text-center">
            Get Started
          </h2>
          <p className="text-center py-1 text-gray-500">Create your account</p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <select name="role" id="role" className="px-4 py-3 border rounded-lg">
